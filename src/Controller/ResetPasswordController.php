...
class ResetPasswordController extends AbstractController
{
    ...
    public function requestResetPassword(Request $request, MailerInterface $mailer): Response
    {
        ...
        return $this->render('security/reset_password/forgotPassword.html.twig', [
     ...
     */
    #[Route('/check-email', name: 'check_email', methods: ['GET', 'POST'])]
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('corenthin95.dev@outlook.fr'))
            ->to($user->getEmail())
